...
% CLAIM: N03
No existing v1, v2, or v3 identity is reused as a fresh same-follower
P/PV/PVA confirmation, and no v4 experiment is part of this paper.  A future
confirmatory comparison would require a new protocol, new identities and
seeds, and a matrix that holds governor and follower execution fixed while
changing only target components.
